...
export const ALT: Record<string, string> = {
  ...
  'detail-pieds-nus-bijoux-sable-seychelles': 'Détail des pieds nus et des bijoux de cheville sur le sable, Seychelles',
  ...
  'mariee-arche-fleurie-plage-seychelles': 'La mariée sous l’arche fleurie dressée sur la plage, Seychelles',
  ...
  'maries-etreinte-plage-rochers-granit-seychelles': 'Étreinte des mariés sur la plage, entre les rochers de granit, Seychelles',
  ...
  'robe-orange-ecume-tronc-plage-seychelles': 'Robe orange dans l’écume, appuyée à un tronc échoué, Seychelles',
  ...
  'vue-aerienne-maries-plage-rochers-granit-seychelles': 'Vue aérienne des mariés sur la plage bordée de rochers de granit, Seychelles',
  ...
  'details-papeterie-mariage-chateau-champlatreux': 'La papeterie du jour posée sur la banquette, château de Champlâtreux',
  ...
  'fou-rire-noir-et-blanc-jardins-coppelia-honfleur': 'Fou rire des mariés, noir et blanc, jardins de Coppélia',
